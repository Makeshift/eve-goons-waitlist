      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">My Fitting and Character Management</h2>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                <div class="statistic-block block">
                  <div class="title">
                    <div class="icon"></div>
                    <!--<strong>Fittings Management</strong>-->
                  ...
                  <!--<div>
                    <div class="collapse" id="fittings">
                      <ul>
                        <li>You can have up to five fits shared between all your pilots.</li>
                        <li>Fittings must be supplied in <b>Ship DNA</b> format.</li>
                        <li>You will be asked to select each fit you wish to waitlist up with on the waitlist page.</li>
                      </ul>
                      <form>
                 ...
                 aria-expanded="false" aria-controls="characterHelp" role="button">advantages</a>.
                  <div>
                    <div class="collapse" id="characterHelp">
                      <ul>
                        <li>You can add any of your pilots to the waitlist.</li>
                        <li>Your fittings and waitlist settings are shared between all your pilots.</li>
                        <li>Your metrics, SRP, and waitlist permissions are shared between all your pilots.</li>
                      </ul>
                    </div>
                  </div>
