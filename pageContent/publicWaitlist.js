...
waitlist.getUserPosition(payloadContent.user.characterID, function(position, found, name) {
  waitlist.getCharsOnWaitlist(payloadContent.user.characterID, function(charList) {
    ...
    var leaveWaitlist = `<a class="btn btn-danger btn-block" href="/remove"><i class="fas fa-exclamation-triangle"></i> Leave the Waitlist</a>`;
    ...
    var queueinfo = "";
    if(position.position !== '##' && payloadContent.fleets.length > 0){
      queueinfo += `
      ...
      waitlistup += `
                    <div class="statistic-block block">
                      ...
                      <form method="POST" action="/" role="form">
                        ...
                        <!-- Select Fits -->
                        <div id="fits">
                          <strong><div class="d-inline" data-toggle="tooltip" data-placement="top" title="This is a temporary system, type your ship type (Example: NYX)" required><i class="fa fa-info-circle" required></i></div> Select your fits </strong>
                          <!--<ul class="list-unstyled">
                            <li>
